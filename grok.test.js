...
describe('Easy', () => {
  ...
  test("Get an object's value using a key", () => {
    const obj = {
      'Peter':'1000',
      'Margo':'500',
      'Natasha':'200'
    }
    expect(funcEasy2(obj, 'Natasha')).toBe('200')
    expect(funcEasy2(obj, 'Peter')).toBe('1000')
    expect(funcEasy2(obj, 'Margo')).toBe('500')
...
describe('Medium', () => {
  test('Outputting each character of a string in the console', () => {
    console.log = jest.fn();
    funcMedium1('Elbrus');
